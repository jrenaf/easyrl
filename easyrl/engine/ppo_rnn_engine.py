...
class PPORNNEngine(PPOEngine):
    ...
    def traj_preprocess(self, traj):
        ...
        if hidden_state is not None:
            ...
            #hidden_state = np.zeros((vals.shape[0], hidden_state_shape[1], hidden_state_shape[2]))
            hidden_state = np.zeros((vals.shape[0], hidden_state_shape[1], hidden_state_shape[2]))
        ...
        # TxN --> NxT
        print('trajshapes', traj.obs.shape, traj.states.shape, hidden_state.shape)
        data = dict(
